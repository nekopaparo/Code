...
public class MariaDB_UpData
{
	public static void main(String[] args)
    {
        ...
        try {
             ...
             //String sqlstr = "insert into employee (num, name, address) values(" + 1001 + ", '" + "Test" + "', '" + "Taiwan" + "')";
             //String delstr = "delete from employee where num=" +  1001 ;
             String updaterstr = "update employee set name='testzxc',address='tasdadasd' where num = '1001' ";
