...
|[SQLite](./MySQLite.cpp)|sqlite3.h<br>[sqlite3.lib](./buildlib.md)<br>sqlite3.dll|sqlite-tools-win32-x86-xxxxxxx.zip|sqlite-dll-win64-x64-xxxxxxx.zip|[download (Windows)](https://sqlite.org/download.html)|同上|
